...
def generate_search_queries_prompt(
    ...
    return (
        ...
        f"The response should only contain the list and using English."
    )
...
write at least {total_words} words.
"""


def generate_resource_report_prompt(
    question, context, report_source, report_format="apa", total_words=2000
):
    reference_prompt = ""
    if report_source == ReportSource.Web.value:
